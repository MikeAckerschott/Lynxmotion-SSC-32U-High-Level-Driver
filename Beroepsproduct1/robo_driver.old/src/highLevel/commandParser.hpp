...
public:
  ...
  */
  void parseCommand(std::string command, std::shared_ptr<HighLevelNode> node);
  ...
  */
  bool parseSingleServoCommand(std::string commandType, std::string command, std::shared_ptr<HighLevelNode> node);
  ...
  * @return True if the command was parsed correctly, false if not
  */
  bool parseMultiServoCommand(std::string commandType, std::string command, std::shared_ptr<HighLevelNode> node);
  ...
  * @return True if the command was parsed correctly, false if not
  */
  bool parseStopCommand(std::string commandType, std::string command, std::shared_ptr<HighLevelNode> node);
  ...
  * @return True if the command was parsed correctly, false if not
  */
  bool parseProgrammedPositionCommand(std::string commandType, std::string command, std::shared_ptr<HighLevelNode> node);
