...
public:
   ...
   */
  void sendSingleServoCommand(short servo, unsigned long long angle, unsigned long long speed, unsigned long long time);
   ...
   */
  void sendMultiServoCommand(std::vector<std::vector<long long>> arguments);
